...
import 'package:markBoot/pages/homeScreen/adminPages/refer_detail_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
                  ...
                  child: ListBody(
                    children: <Widget>[
                      TextField(
                        controller: t1,
                        maxLines: 1,
                        decoration: InputDecoration(hintText: "Enter New Refer Code",
                        ),),
                ...
                actions: <Widget>[
                  TextButton(
                    ...
                    onPressed: () async {
                      ...
                      try{await Firestore.instance.collection("invitecodes").document(
                          "${t1.text.toUpperCase().trim()}").setData({
                        "invitedBy":"admin",
                        "invitedTo":[],
                      ...
                      Fluttertoast.showToast(msg: "Code entered Successfully");}
                      catch(err){
                        Fluttertoast.showToast(msg: "Sorry there was an error while uploading please add a new code or check your connection ");
                      }
        ...
        },child: Icon(Icons.add,color: Colors.white,),backgroundColor: Colors.yellow,
      ),
      appBar: AppBar(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) =>ReferDetailPage(a: doc.data['invitedTo'],rid: doc.data['referCode'].toString(),)));},
                      child: Container(
